...
if (userAge < ageUnder) {
    ...
    document.getElementById("fascia_minorenni").innerHTML = "il prezzo del biglietto dell'utente minorenne è di: " + bigliettoUnder + "€"
   /*  console.log("il prezzo del biglietto dell'utente minorenne è: " + bigliettoUnder + "€"); */
    ...
    document.getElementById("fascia_over").innerHTML = "il prezzo del biglietto dell'utente della fascia over 65 è di: " + bigliettoOver + "€"
    /* console.log("il prezzo del biglietto dell'utente della fascia over 65 è: " + bigliettoOver + "€");
 */
} else {
    document.getElementById("fascia_regolare").innerHTML = "il prezzo del biglietto regolare è di: " + prezzoTotale + "€"
